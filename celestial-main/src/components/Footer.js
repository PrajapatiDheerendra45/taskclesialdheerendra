...
import { FaInstagram, FaLinkedinIn, FaTwitter, FaWhatsapp, FaPinterestP } from "react-icons/fa";
    ...
    return (
        <footer className="bg-[#214344] text-white py-10 w-full">
            <div className="container grid grid-cols-1 sm:grid-cols-2 md:text-center px-4 md:px-36 md:grid-cols-4 md:w-full">
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-4 text-left text-[#f0d5a0]">Let Us Help You</h3>
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-4 text-left text-[#f0d5a0]">The Collection</h3>
                    <ul className="space-y-2 text-left text-sm font-semibold leading-normal">
                ...
                <div className="text-left sm:text-center">
                    ...
                    <div className="sm:w-48 flex flex-col justify-between leading-loose">
                        <h3 className="text-lg font-semibold mb-4 text-left text-[#f0d5a0]">Contact Details</h3>
                        <p className="text-left text-sm font-semibold py-3">+91 9616773377</p>
                        <p className="text-left text-sm font-semibold py-3">hello@zoci.in</p>
                        <p className="text-left text-sm font-semibold py-3">Monday – Friday: 9:00 AM - 8:00 PM</p>
                        <p className="text-left text-sm font-semibold py-3">Santacruz East, Mumbai, Maharashtra 400055</p>
                    </div>

                    {/* Help Section */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-left text-[#f0d5a0]">Help</h3>
                        <ul className="space-y-2 text-left text-sm font-semibold leading-normal">
            ...
            <div className="mt-10 pt-6 text-center text-[#f0d5a0]">
                ...
                </p><p className="text-sm text-white md:mx-4 ">
